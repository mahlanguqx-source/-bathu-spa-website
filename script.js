<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><title>Premium Clean — Bathu Spa</title><link rel="stylesheet" href="styles.css"/></head><body><a class="skip-link" href="#main">Skip to content</a>
...
</header><main id="main"><section class="section"><div class="container"><h1 class="title">Premium Clean</h1><img class="card__img" src="assets/service-premium.jpg" alt="Premium Clean"/><p class="muted" style="margin-top:10px">Premium materials. Precision technique. Luxury finish.</p><div style="margin-top:14px"><a class="btn btn--gold" target="_blank" rel="noopener" href="https://wa.me/27790834264">Book on WhatsApp</a> <a class="btn btn--ghost" href="pricing.html">See pricing</a></div></div></section></main><footer class="footer" id="contact"><div class="container">
